    ...
    <Container>
      <SearchArea>
        ...
        <CriteriaPanel>
          ...
          />
          <CriteriaOptionLabel>{t('pages.relevante')}</CriteriaOptionLabel>
          ...
          />
          <CriteriaOptionLabel>{t('pages.recente')}</CriteriaOptionLabel>
        </CriteriaPanel>

        <SearchButton onClick={() => searchPhotos()}>{t('pages.buscar')}</SearchButton>
      </SearchArea>
